            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item"><a href="<?php echo base_url('') ?>" class='sidebar-link'><i class="bi bi-calendar"></i><span>Agenda Ruang</span></a>
                        </li>
                        ...
                        <li class="sidebar-item has-sub"><a href="#" class='sidebar-link'><i class="bi bi-cloud-arrow-up-fill"></i><span>Peminjaman</span></a>
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item "><a href="<?php echo base_url('') ?>">Status</a></li>
                            </ul>
                        </li>
